...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <!-- /.navbar-collapse -->
    ...
    <div class="container-fluid" >
        ...
        <!-- /.row -->
        <div class="row">
            <form action="/admin.php" method="get" id="f1">
                ...
                <div class="input-group">
                    ...
                    <button id="sub_data" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i></button>
                </span>
                </div>
            </form>
        </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover cms-table">
                        ...
                        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span class="glyphicon glyphicon-edit menu_editClass" aria-hidden="true" id="cms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span>
                                    <a href="javascript:void(0)"  attr-id="<?php echo ($menu["menu_id"]); ?>" id="cms-delete"  attr-a="menu" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
