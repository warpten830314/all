  ...
  <!-- /.navbar-collapse -->
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="/admin.php" id="f1" method="post">
                    <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-lg-6" id="new1">
                    ...
                    <div class="table-responsive">
                        ...
                        <div>
                            <button id="button-listorder" type="submit" class="btn btn-primary dropdown-toggle"><span
...
<script>
  var SCOPE = {
    ...
    'listorder_url': '/admin.php?c=positioncontent&a=listorder',
      ...
      'search_url' : '/admin.php?c=positioncontent&a=search',
  }
